...
class SecurityController extends AbstractController
{
            ...
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        ...
                        new OA\Property(property: 'apiToken', type: 'string', example: 'qg5g56rtg...'),
    ...
    #[OA\Put(
        path: '/api/edit',
        summary: 'Modification des informations utilisateur',
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(
                properties: [
    ...
    {
        if ($user) {
            // Hydratation de l'utilisateur existant
            ...
            // Gestion manuelle du hachage si le mot de passe est présent dans le JSON
